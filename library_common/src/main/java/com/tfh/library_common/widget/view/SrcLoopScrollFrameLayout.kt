...
class SrcLoopScrollFrameLayout : FrameLayout {
    ...
    private fun initView(context: Context, attrs: AttributeSet?, defStyleAttr: Int) {
        val array = context.theme.obtainStyledAttributes(
            attrs,
            R.styleable.CommonSrcLoopScrollFrameLayout,
            defStyleAttr,
            0
        )
        val speed = array.getInteger(R.styleable.CommonSrcLoopScrollFrameLayout_commonSpeed, 3)
        mScrollOrientation =
            array.getInteger(R.styleable.CommonSrcLoopScrollFrameLayout_commonScrollOrientation, OUT_SLIDE_TOP)
        mIntervalIncreaseDistance *= speed
        mDrawable = array.getDrawable(R.styleable.CommonSrcLoopScrollFrameLayout_commonSrc)
        mIsScroll = array.getBoolean(R.styleable.CommonSrcLoopScrollFrameLayout_commonIsScroll, true)
        mMaskLayerColor =
            array.getColor(R.styleable.CommonSrcLoopScrollFrameLayout_commonMaskLayerColor, Color.TRANSPARENT)
        array.recycle()
