 ...
 */
public class CommonMaterialSearchBar extends FrameLayout implements View.OnClickListener,
    ...
    public CommonMaterialSearchBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public CommonMaterialSearchBar(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public CommonMaterialSearchBar(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//                onSearchActionListener.onButtonClicked(BUTTON_SPEECH);
    ...
    private static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = new Creator<SavedState>() {
            @Override
            public CommonMaterialSearchBar.SavedState createFromParcel(Parcel source) {
                return new CommonMaterialSearchBar.SavedState(source);
            }

            @Override
            public CommonMaterialSearchBar.SavedState[] newArray(int size) {
                return new CommonMaterialSearchBar.SavedState[size];
            }
        };
